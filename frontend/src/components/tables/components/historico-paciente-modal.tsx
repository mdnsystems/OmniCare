...
interface HistoricoPacienteModalProps {
  isOpen: boolean;
  onClose: () => void;
  pacienteId: string;
}

export function HistoricoPacienteModal({ isOpen, onClose, pacienteId }: HistoricoPacienteModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="min-w-[60vw] max-h-[90vh] overflow-hidden" showCloseButton={false}>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold">{paciente.convenio?.nome || 'Não informado'}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
